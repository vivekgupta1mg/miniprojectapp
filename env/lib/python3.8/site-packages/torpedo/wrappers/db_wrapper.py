...
class ORMWrapper:
    ...
    @classmethod
    async def update_with_filters(cls, row, model, payload, where_clause=None,
                                  update_fields=None):
        """
        :param row: database model instance which needs to be updated
        :param model: database model class on which filters and update will be applied.
    ...
    async def get_or_create_object(cls, model, payload, defaults=None):
        ...
        :param defaults: values on which will used to create the data which we do not
    ...
    @classmethod
    async def get_by_filters_count(cls, model, filters, order_by=None, limit=None, offset=None):
        """
        :param model: database model class
        :param filters: where conditions for filter
        :param order_by: for ordering on queryset
    ...
    @classmethod
    async def annotate_by_filters(cls, model, filters, column, function, group_by=None,
                                  order_by=None, values=None):
        """
        :param model: model object
        :param filters: where conditions for filter
        ...
        try:
            ...
            raise BadRequestException("Invalid function name: {}".format(function))
