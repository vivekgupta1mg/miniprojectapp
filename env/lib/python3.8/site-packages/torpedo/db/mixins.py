...
class ModelUtilMixin:
    ...
    async def to_dict(self: Model, filter_keys=None, get_related=True,
                      related_fields=None):
        """

        :param filter_keys: Any Specific Keys which required in the Dictionary Object,
        if not mentioned, all the Model values will be added to the Dictionary Object.
        ...
        serializable_types = [str, int, list, tuple, dict, bool, set, type(None), float, UUID,
                              datetime, date]
        result = dict()
        ...
        # If no Filter Keys are given, all the variables of the Model class will be taken in
        # account.
        if not filter_keys:
